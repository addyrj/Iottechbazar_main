...
import { attributeLanState, getAttributeData, setLoder } from '../../../../Database/Action/AdminAction';
...
const AdminAttributes = () => {
  ...
  const deleteAttribute = (slug) => {
    let formData = new FormData();
    formData.append("slug", slug)
    dispatch(setLoder(true));
    axios.post(process.env.REACT_APP_BASE_URL + "deleteAttribute", formData, postHeaderWithToken)
      .then((response) => {
              ...
              <div className="card">
                <div className="card-body mb-4">
                  <div className='page-event'>
                    <NavLink to={"/admin_add_attributes"} className='buttonStyle'>Create Attribute</NavLink>
                  </div>
                  <table
                    id="datatable"
                    ...
                    style={{ width: "100%" }}
                  >
                    {attributeData?.length === 0 ? <div className='noDataStyle'>
                      ...
                      <>
                        <thead>
                          <tr>
                            ...
                            <th className="col-3 text-center">Added By</th>
                                ...
                                <td className="table-text-style text-center">
                                  <li className="nav-item dropdown" style={{ listStyleType: "none" }}>
                                    ...
                                    <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right p-2">
                                      <NavLink to={"/admin_add_attributes"} className="dropdown-item mt-2 mb-1"
                                        state={{
                                          slug: currElem.slug,
                                          name: currElem.name,
                                      ...
                                      <a className="dropdown-item mt-2 mb-1" style={{ cursor: "pointer" }}>
                                        <div className="media"
                                          onClick={() => deleteAttribute(currElem.slug)}
                                        >
                                      ...
                                      <a className="dropdown-item mt-2 mb-1" style={{ cursor: "pointer" }}>
                                        <div className="media" onClick={() => dispatch(attributeLanState({ attrState: true, attributeSlug: currElem.slug }))}
                                        >
