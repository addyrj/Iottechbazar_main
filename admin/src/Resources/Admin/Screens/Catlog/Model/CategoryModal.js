...
import { categoryLanState, getAppLanguages, setLoder } from '../../../../../Database/Action/AdminAction';
...
const CategoryModal = () => {
    ...
    const { catLanState, catSlug } = useSelector((state) => state.ConstantReducer);
    ...
    const updateLanguage = () => {
        if (isEmpty(catSlug)) {
            ...
            axios.post(process.env.REACT_APP_BASE_URL + "updateCategoryLanguage", formData, postHeaderWithToken)
                .then((res) => {
                    if (res.data.status === 200) {
                        dispatch(setLoder(false));
                        toast.success(res?.data?.message);
                        dispatch(categoryLanState(false))
                    }
                })
                .catch((error) => {
    ...
    return (
        <Modal
            ...
            open={catLanState}
            onClose={() => dispatch(categoryLanState(false))}
                ...
                >
                    <div className="card mb-0">
                        <div
                            ...
                            <h3 className="card-title text-white col-9">Add Category Name</h3>
                            <button style={{
                                width: "200px",
                                height: "2.5rem",
                                color: "white",
                        ...
                        <form>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    style={buttonStyle}
                                    onClick={() => dispatch(categoryLanState(false))}
                                >
                                    Cancel
                                </button>
                            </div>
