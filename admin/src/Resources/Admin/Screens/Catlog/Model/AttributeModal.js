...
import { attributeLanState, getAppLanguages, setLoder } from '../../../../../Database/Action/AdminAction';
...
const AttributeModal = () => {
    ...
    const { attrLanState, attributeSlug } = useSelector((state) => state.ConstantReducer);
    ...
    const updateLanguage = () => {
        if (isEmpty(attributeSlug)) {
            ...
            axios.post(process.env.REACT_APP_BASE_URL + "addAttributeLanguage", formData, postHeaderWithToken)
                .then((res) => {
                    if (res.data.status === 200) {
                        dispatch(setLoder(false));
                        toast.success(res?.data?.message);
                        dispatch(attributeLanState({ attrState: false, attributeSlug: "" }))
                    }
                })
                .catch((error) => {
    ...
    return (
        <Modal
            ...
            open={attrLanState}
            onClose={() => dispatch(attributeLanState({ attrState: false, attributeSlug: "" }))}
                ...
                >
                    <div className="card mb-0">
                        <div
                            ...
                            <h3 className="card-title text-white col-9">Add Attribute Name</h3>
                            <button style={{
                                width: "200px",
                                height: "2.5rem",
                                color: "white",
                        ...
                        <form>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    style={buttonStyle}
                                    onClick={() => dispatch(attributeLanState({ attrState: false, attributeSlug: "" }))}
                                >
                                    Cancel
                                </button>
                            </div>
