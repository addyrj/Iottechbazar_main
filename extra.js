...
const AdminAddProduct = () => {
    ...
    // Extract product data from location.state for edit mode
    const productData = location.state || {};
    
    // Check if we're in edit mode
    const isEditMode = !!productData.slug;
    ...
    // Initialize productInfo with existing data for edit mode or empty for create mode
    const [productInfo, setProductInfo] = useState({
        productName: productData.name || "",
        subScript: productData.subScript || "",
        hsnCode: productData.hsnCode || "",
        productSku: productData.poductSku || "",
        ...
        // Add slug for edit mode
        ...(isEditMode && { slug: productData.slug })
    });
    ...
    // Load subcategory and attribute family data when category/attribute is set
    useEffect(() => {
        if (productInfo.category && allSubCategoryData.length > 0) {
            getSubCategoryData(productInfo.category);
        }
        
        if (productInfo.attribute && allFamilyAttribute.length > 0) {
            getAttributeFamily(productInfo.attribute);
        }
    }, [productInfo.category, productInfo.attribute, allSubCategoryData, allFamilyAttribute]);
                    ...
                    <div className="row mb-4">
                        <div className="col-12">
                            <h2>
                                ...
                                {/* {isEditMode && <small className="text-muted"> - {productData.name}</small>} */}
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="card card-primary">
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        <label htmlFor="subScript">Sub-Script*</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                            id="subScript"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        <div className="form-control select2">
                                            <div className="row">
                                                ...
                                                <div
                                                    className="col-1"
                                                    onClick={() => setMultipleSelect(multipleSelect === 0 ? 1 : 0)}
                                    ...
                                    <div className={multipleSelect === 1 ? "multipleSelectBoby" : "d-none"} style={{ width: "100%" }}>
                                        <ul>
                                            {productTitles?.map((item) => {
                                                return (
                                                    <li
                                                        ...
                                                        value={item.name}
                                                        onClick={() => handleChangeMultiple([{ name: item.name, slug: item.slug }])}
                                                    >
                                                        <a>{item.name}</a>
                                                    </li>
                                                );
                    ...
                    <div className="card card-primary">
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        <label htmlFor="specialPrice">Product Special Price*</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                            id="specialPrice"
                    ...
                    <div className="card card-primary">
                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="card card-outline card-info">
                                        <div className="card-header">
                                            <h3 className="card-title" style={{ fontWeight: "700" }}>Description*</h3>
                                        </div>
                                        <div className="card-body">
                                            <ReactQuill
                                                theme="snow"
                                                ...
                                                modules={module}
                                                onChange={(value) => setProductInfo({...productInfo, productDesc: value})}
                                            />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6">
                                    <div className="card card-outline card-info">
                                        <div className="card-header">
                                            <h3 className="card-title" style={{ fontWeight: "700" }}>Specification*</h3>
                                        </div>
                                        <div className="card-body">
                                            <ReactQuill
                                                theme="snow"
                                                ...
                                                modules={module}
                                                onChange={(value) => setProductInfo({...productInfo, productSpec: value})}
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="card card-outline card-info">
                                        <div className="card-header">
                                            <h3 className="card-title" style={{ fontWeight: "700" }}>Offer*</h3>
                                        </div>
                                        <div className="card-body">
                                            <ReactQuill
                                                theme="snow"
                                                ...
                                                modules={module}
                                                onChange={(value) => setProductInfo({...productInfo, productOffer: value})}
                                            />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6">
                                    <div className="card card-outline card-info">
                                        <div className="card-header">
                                            <h3 className="card-title" style={{ fontWeight: "700" }}>Manufacturer*</h3>
                                        </div>
                                        <div className="card-body">
                                            <ReactQuill
                                                theme="snow"
                                                ...
                                                modules={module}
                                                onChange={(value) => setProductInfo({...productInfo, productManufacturer: value})}
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="card card-outline card-info">
                                        <div className="card-header">
                                            <h3 className="card-title" style={{ fontWeight: "700" }}>Warranty*</h3>
                                        </div>
                                        <div className="card-body">
                                            <ReactQuill
                                                theme="snow"
                                                ...
                                                modules={module}
                                                onChange={(value) => setProductInfo({...productInfo, productWarranty: value})}
                                            />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="card-footer">
                            <button
                                ...
                                onClick={isEditMode ? updateProduct : createProduct}
                            >
